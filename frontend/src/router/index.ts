...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/historia', name: 'history', component: () => import('../views/History.vue') },
    { path: '/nosotros', name: 'aboutUs', component: () => import('../views/AboutUs.vue') },
    { path: '/contacto', name: 'contacto', component: () => import('../views/Contact.vue') },
